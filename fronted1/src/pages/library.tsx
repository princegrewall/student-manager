    ...
    return (
      <div className="min-h-screen flex flex-col bg-[#1A1F2C] text-white">
        ...
        <main className="flex-grow container mx-auto py-8 px-4 flex justify-center items-center">
          <RefreshCw className="h-8 w-8 animate-spin mr-2 text-purple-500" />
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#1A1F2C] text-white">
          ...
          <div className="space-y-8">
            <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
              <div>
                ...
                <p className="text-gray-400">Browse, download, and manage educational resources</p>
              </div>
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 bg-[#232323] border-[#444444] text-white"
              />
            </div>
            ...
            {isTeacher && (
              <div className="w-full">
                ...
                <div className="bg-[#232323] w-full p-4 mb-6 rounded-md">
                  <div className="flex justify-between items-center">
                    <div>
                      <h2 className="text-xl font-bold text-white">My Books by Semester</h2>
                      <p className="text-gray-400 text-sm mt-1">
                        View your uploaded books organized by semester. <span className="text-yellow-400">Note: As a teacher, you can only see your own uploads.</span>
                      </p>
                    </div>
                    <Button 
                ...
                {loading ? (
                  <div className="flex justify-center py-20">
                    <div className="flex items-center space-x-2">
                      <RefreshCw className="animate-spin h-5 w-5 text-purple-500" />
                      <span className="text-gray-400">Loading all books...</span>
                    </div>
                  </div>
                ) : (
                  <div className="grid grid-cols-1 gap-4">
                    {semesters.map((semester) => {
                      ...
                      return (
                        <div key={semester} className="bg-[#222222] rounded-lg border border-[#333333] overflow-hidden">
                          <button
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-2">
                              {semesterBooks.length > 0 ? (
                                semesterBooks.map((book) => (
                                  <Card 
                                    key={book._id} 
                                    className="overflow-hidden bg-[#222222] border-[#333333] hover:border-purple-700 transition-all"
                                  >
                                    <CardHeader className="p-4 pb-2 space-y-1">
                                      <CardTitle className="text-lg font-semibold text-white line-clamp-2">{book.title}</CardTitle>
                                      <CardDescription className="text-sm text-gray-400">
                                        By {book.author}
                                      </CardDescription>
                                    </CardHeader>
                                    <CardContent className="p-4 pt-2 space-y-4">
                                      <p className="text-sm text-gray-300 line-clamp-3">{book.description || "No description available"}</p>
                                      ...
                                      <div className="flex items-center justify-between">
                                        <Button
                                          ...
                                          className="bg-purple-950/30 text-purple-300 hover:bg-purple-900/50"
                                        >
                                        ...
                                        {canEditLibrary && (isBookOwner(book) || isCoordinator) && (
                                          <div className="flex gap-2">
                                            <Button
                                              ...
                                              className="h-8 w-8 bg-[#333333] border-[#444444] hover:bg-[#444444]"
                                            >
                                            ...
                                            <Button
                                              ...
                                              className="h-8 w-8 bg-[#333333] border-[#444444] hover:border-red-700 hover:bg-red-950/30"
                                            >
                                ...
                                <div className="col-span-full text-center p-8">
                                  ...
                                  <p className="text-gray-400">No books found for Semester {semester}</p>
                                </div>
                              )}
                            </div>
                          )}
                    ...
                    {myBooks.length === 0 && (
                      <div className="text-center py-16 bg-[#222222] rounded-xl border border-[#333333] mt-4">
                        <BookOpen className="h-16 w-16 mx-auto mb-4 text-gray-600" />
                        <h3 className="text-xl font-medium text-gray-300 mb-2">No books uploaded yet</h3>
                        <p className="text-gray-400 mb-6 max-w-md mx-auto">You haven't uploaded any books to the library yet.</p>
                        {canEditLibrary && (
                          <Button 
                            onClick={() => {
                              setEditMode(false);
              ...
              <>
                {loading ? (
                  <div className="flex justify-center py-20">
                    <div className="flex items-center space-x-2">
                      <RefreshCw className="animate-spin h-5 w-5 text-purple-500" />
                      <span className="text-gray-400">Loading library resources...</span>
                    </div>
                  </div>
                ) : (
                  <div className="grid grid-cols-1 gap-4">
      ...
      {deleteConfirmation && (
        <Dialog open={!!deleteConfirmation} onOpenChange={(open) => !open && setDeleteConfirmation(null)}>
          <DialogContent className="bg-[#2A2A2A] text-white border-[#444444]">
            ...
            <div className="py-4">
              <p className="text-gray-300 mb-4">Are you sure you want to delete this book? This action cannot be undone.</p>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="bg-[#222222] border-[#333333] text-white max-w-lg">
          <DialogHeader>
          ...
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                className="col-span-3 bg-[#333333] border-[#444444] text-white"
                required
              />
            </div>
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <select
                ...
                className="col-span-3 bg-[#333333] border-[#444444] rounded p-2 text-white"
                required
              >
                {semesters.map((sem) => (
            ...
            <div className="grid grid-cols-4 items-start gap-4">
              ...
              <Textarea
                ...
                className="col-span-3 bg-[#333333] border-[#444444] text-white min-h-24"
              />
            </div>
